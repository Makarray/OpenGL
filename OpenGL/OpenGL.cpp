...
* * Arrow keys	     => Turn head in direction
* * r, f	     => Move up/down
* * t		     => Toggle wireframes
* * Shift Left/Right => Rotate image on Z axis
* * CTRL Arrow Keys  => Global Rotations
*
* Gitfile: https://github.com/Makarray/OpenGL.git
* ************************************************/
...
GLdouble eyefocus[3] = {0,0,7};	//start directly forwards
bool isFilled = true;
...
/*****************************
* Entry point of application, and setup glut/callbacks
* ***************************/
...
/********************************
* Keyboard handler calls moveEye or exits on esc
* *****************************/
void keyboard(unsigned char key, int x, int y){
	switch (key)
	{
...
/**********************************
* Moves the modelview matrix around the camera
* *********************************/
bool moveEye(int direction){
	switch (direction){
	case 0:		//Forward
...
/*******************************
* Sets background color and various options
* Initializes the object matrix
* ******************************/
void init(){
...
/**********************************
* Resizes the window in perspective mode
* *******************************/
void resize (int w, int h){
